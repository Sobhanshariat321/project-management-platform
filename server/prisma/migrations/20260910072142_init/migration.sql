...
-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('task_created', 'task_updated', 'task_deleted', 'task_moved', 'comment_added', 'comment_updated', 'comment_deleted', 'member_added', 'member_removed');
